			...
			<div className="ui card">
				<div className="card">
					<img
						...
						src={require("../../img/leon.jpg")}
						alt=""
					/>
					<div className="content">
						<div className="header">{profile.user.name}</div>
						<div className="meta">{profile.status}</div>
						{/* <div className="description">{profile.bio}</div> */}
					</div>
					<div className="extra content">
						<span className="right floated mr-3">Joined in 2019</span>
						<span>
